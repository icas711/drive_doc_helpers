...
enum ApplicationStatus implements Comparable<ApplicationStatus> {
  ...
  updated(title: 'Обновлена', color: Color(0xFF416AF0),svgPath: 'assets/images/application_in_progress.svg'),
  ...
  factory ApplicationStatus.fromString(String text) {
    ...
    }  else if (text == ApplicationStatus.updated.name) {
      return ApplicationStatus.updated;
    }else if (text == ApplicationStatus.closed.name) {
