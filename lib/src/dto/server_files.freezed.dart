...
mixin _$ServerFile {
  ...
  String? get hiddenFieldId => throw _privateConstructorUsedError;
  @DateTimeConverter()
...
abstract class $ServerFileCopyWith<$Res> {
  ...
  $Res call(
      ...
      @DateTimeConverter() DateTime? lastModifiedTime,
      String? version,
      String? size,
      String? checksum});
}
    ...
    return _then(_value.copyWith(
      ...
      filename: freezed == filename
          ...
          : filename // ignore: cast_nullable_to_non_nullable
              as String?,
      hiddenFieldId: freezed == hiddenFieldId
          ? _value.hiddenFieldId
          : hiddenFieldId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ServerFileImpl implements _ServerFile {
  _$ServerFileImpl(
      ...
      required this.hiddenFieldId,
      @DateTimeConverter() required this.lastModifiedTime,
  ...
  @override
  String toString() {
    return 'ServerFile(id: $id, filename: $filename, hiddenFieldId: $hiddenFieldId, lastModifiedTime: $lastModifiedTime, version: $version, size: $size, checksum: $checksum)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.hiddenFieldId, hiddenFieldId) ||
                other.hiddenFieldId == hiddenFieldId) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, filename, hiddenFieldId,
      lastModifiedTime, version, size, checksum);
...
abstract class _ServerFile implements ServerFile {
  factory _ServerFile(
      ...
      required final String? hiddenFieldId,
      @DateTimeConverter() required final DateTime? lastModifiedTime,
      required final String? version,
      required final String? size,
      required final String? checksum}) = _$ServerFileImpl;
